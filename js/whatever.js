...
if (hour < 12) {
    ...
    document.getElementsById("solarnlunarmass")[0].classList.add("morning-bg");
    ...
    document.getElementsById("solarnlunarmass")[0].classList.add("noon-bg");
    document.querySelector(".morning").classList.add("d-none");
    document.querySelector(".night").classList.add("d-none");
  } // hour is greater than 17:00
  else {
    greetingText.textContent = "Good Night!";
    greetingText.getElementById("solarnlunarmass").classList.add("night-gradient");
    document.querySelector(".morning").classList.add("d-none");
    document.querySelector(".afternoon").classList.add("d-none");
  }
